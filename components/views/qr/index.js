	...
	return (
		<div className='flex flex-col justify-center h-[100vh] w-[100vw]   qr-page-bg-style'>
			...
			<div className='flex absolute top-[110px] z-[300] items-center justify-around h-[40px] w-[100%] font-bold font-[Bahij]'>
				<span className='text-[#E4D078] text-[24px]'>
					{t("qr.unitedAmbalaj")}
				</span>
			</div>
			...
			<div className='flex absolute top-[160px] z-[300] items-center justify-around h-[40px] w-[100%]'>
				<a href='tel:+50225079227;1' target='_blank' rel='noopener noreferrer'>
					<span className='text-black text-[20px] font-bold font-[Bahij]'>
						{t("qr.call")}
					</span>
				</a>
				...
				<a
					href={`https://goo.gl/maps/qGru7ih9HPQtr3Ja6`}
					target='_blank'
					rel='noopener noreferrer'
				>
					<span className='text-black text-[20px] font-bold font-[Bahij]'>
			...
			<div className='mt-[240px] w-[100%] px-[40px]'>
				<div className='flex items-center w-[100%] my-[13px] '>
					...
					<div className='flex flex-col w-[100%] items-center'>
						<a href='tel:+50225079227;1'>
							<span
								className='text-white text-[18px] my-[16px] font-sans'
								dir='ltr'
							>
								+905385800069
							</span>
				...
				<div className='flex items-center w-[100%]  my-[13px]'>
					...
					<div className='flex flex-col w-[100%] items-center'>
						<a href='https://homacomakina.com/'>
							<span className='text-white text-[18px] my-[16px]'>
								{t("qr.ourProducts")}
							</span>
						</a>
				...
				<div className='flex items-center w-[100%] my-[13px] '>
					...
					<div className='flex flex-col w-[100%] items-center'>
						<a href='https://homacomakina.com/'>
							<span className='text-white text-[18px] my-[16px] font-sans'>
								homacomakina.com
							</span>
						</a>
				...
				<div className='flex items-center w-[100%] my-[13px] '>
					...
					<div className='flex flex-col w-[100%] items-center'>
						<a
							href='https://homacomakina.com/'
							className='flex flex-col justify-center   items-center'
						>
							<span className='text-white text-[18px] my-[0px] text-center p-[10px] font-sans  '>
			...
			<div className='pr-[30px] mt-[10px] w-[100%]   flex items-center justify-between  mb-[40px] px-[80px]'>
				<div className='h-[82px] w-[90px]'>
					<a
						href='https://www.facebook.com/homacomakina.com'
						className='flex flex-col justify-center   items-center'
					>
						<Image
							src={"/images/face.png"}
				...
				<div className='h-[82px] w-[90px]'>
					<a
						href='https://www.instagram.com/homacomakina.com'
						className='flex flex-col justify-center   items-center'
					>
						<Image
